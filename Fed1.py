...
if __name__ == "__main__":
    ...
    granted_time = 0    
    results = {"Amplified Sin": [], "Amplified Cos": []}
    ...
    plt.figure()
    plt.title("Amplified Sin and Cos from Fed2, plot generated by Fed1")
    plt.plot(results["Amplified Sin"], label="Amplified Sin")
    plt.plot(results["Amplified Cos"], label="Amplified Cos")
    plt.legend()
    plt.show()
